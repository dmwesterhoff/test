# Pinn Demo App Server OpenAPI Specification
[![Build Status](https://travis-ci.org/dmwesterhoff/test.svg?branch=master)](https://travis-ci.org/dmwesterhoff/test)
...
6. If you did everything correct, https://dmwesterhoff.github.io/test/ will lead to your new docs
...
- Documentation(ReDoc): https://dmwesterhoff.github.io/test/
- Look full spec:
    + JSON https://dmwesterhoff.github.io/test/swagger.json
    + YAML https://dmwesterhoff.github.io/test/swagger.yaml
- Preview spec version for branch `[branch]`: https://dmwesterhoff.github.io/test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://dmwesterhoff.github.io/test/ with url from the message: `Server started <url>`
